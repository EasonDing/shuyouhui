    ...
    export default {
        ...
        methods: {
            ...
            paginate: function (val) {
                this.page = val
                this.getTradingMoney()
            },
            //api获得数据
            getTradingMoney: function () {
                this.loading = true
                axios.get('/api/admin/finance/trading/count?page=' + this.page).then(response => {
                    this.tradingMoney = response.data.data.data;
