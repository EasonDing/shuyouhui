    ...
    <div class="animated fadeIn">
        <el-card class="box-card" v-loading="loading" element-loading-text="拼命加载中">
            <div slot="header" class="clearfix">
                <el-button type="success" @click="addBook()">添加新书</el-button>
                <div style="float: right;">
                    <el-form>
                        ...
                        <el-input @change="getBooks" clearable style="width: 260px;" v-model="keyword" placeholder="输入书名"></el-input>
                        <el-button type="primary">搜索</el-button>
                    </el-form>
                </div>
            </div>

            <div v-if="books == 0" style="text-align: center;"><span style="color: #5e7382;">暂无数据</span></div>
            <template v-for="book in books">
                <el-row :span="24">
                    ...
                    <el-col :span="3" style="float: right; height: 100px; line-height: 100px;">
                        ...
                        <el-button type="danger" size="small" @click="destroyBook(book)">删除</el-button>
                    </el-col>
                </el-row>
            </template>
            <!--分页-->
    ...
    export default{
        ...
        methods: {
            ...
            getBooks: function () {
                const self = this;
                self.loading = true
                axios.get('/api/admin/book/index', {
                    params: {
                        page: self.page,
                        search: self.keyword,
                        date: self.date,
            ...
            editBook:function (row) {
                this.$router.push('/admin/book/' + row.id + '/edit');
            },
            //删除贝壳图书
            destroyBook: function (row) {
                ...
                self.$confirm('删除此书, 是否继续?', '提示', {
                    ...
                    axios.get('/api/admin/book/destroy/' + row.id ).then(response => {
