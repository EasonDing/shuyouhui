                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <div v-if="scope.row.book">
                            <img :src="scope.row.book.image" style="width: 80px;height: 100px; float:left; padding: 7px;"/>
    ...
    export default {
        ...
        methods: {
            ...
            getOrders: function () {
                const self = this;
                self.loading = true
                axios.get('/api/admin/order/index',{
                    params: {
                        page: self.page,
                        search: self.keyword,
                        date: self.date,
            ...
            destroyOrder:function (row) {
                this.$confirm('删除此订单？, 是否继续', '提示', {
                    ...
                    axios.get('/api/admin/order/destroy/' + row.id).then(response => {
