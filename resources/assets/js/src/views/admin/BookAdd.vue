        ...
        <el-card class="box-card">
            ...
            <el-form :model="books" :rules="rules" ref="books" label-width="100px" class="demo-books">
                ...
                <el-form-item label="推荐语" prop="summary">
                    <el-input type="textarea" v-model="books.summary" class="new-book-input"></el-input>
                </el-form-item>
                <el-form-item>
                    ...
                    if (valid) {
                        self.$confirm('保存图书信息, 是否继续?', '提示', {
                            ...
                            Object.keys(this.books).map(key => {
                                self.formData.append(key, this.books[key]);
                            });
                            axios.post('/api/admin/book/store', self.formData).then(response => {
